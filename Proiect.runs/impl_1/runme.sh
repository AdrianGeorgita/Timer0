...
HD_PWD='D:/Vivado Projects/Proiect/Proiect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TIMER0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TIMER0.tcl -notrace
