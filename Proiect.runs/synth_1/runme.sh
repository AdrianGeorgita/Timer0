...
HD_PWD='D:/Vivado Projects/Proiect/Proiect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TIMER0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TIMER0.tcl
