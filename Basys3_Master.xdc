...
set_property PACKAGE_PIN R2 [get_ports {set_clk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_clk}]
...
set_property PACKAGE_PIN L1 [get_ports {TMRIF}]					
...
set_property PACKAGE_PIN U18 [get_ports clk_ex]						
	...
	set_property clock_dedicated_route false[get_nets counter_clock_ibuf]
